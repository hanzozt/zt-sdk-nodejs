...
function load_addon() {
    try {
        return require('../build/Debug/zt_sdk_nodejs');
    } catch {
        return require('../build/Release/zt_sdk_nodejs');
    }
}
 ...
 * @param {string} schemeHostPort - The scheme/host/port (e.g. http://myserver.zt:8080) of a Ziti service-config/intercept to send the request. (mutually exclusive with serviceName)
